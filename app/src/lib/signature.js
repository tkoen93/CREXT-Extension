const API_TYPES = require("../gen-nodejs/api_types");
const GEN_TYPES = require("../gen-nodejs/general_types");
  ...
  if(Obj.Source === undefined) {
    Obj.Source = Buffer.from(await key.exportPublic(currentSelected, 1));
        ...
        */
        ...
        Trans.fee = new API_TYPES.AmountCommission({
