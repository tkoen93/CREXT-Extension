...
var SmartStateTransInfo = module.exports.SmartStateTransInfo = function(args) {
  ...
  if (args) {
    ...
    if (args.executionFee !== undefined && args.executionFee !== null) {
      this.executionFee = new ttypes.Amount(args.executionFee);
    }
...
SmartStateTransInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.executionFee = new ttypes.Amount();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i37 = 0; _i37 < _size32; ++_i37)
        {
          var key38 = null;
          var val39 = null;
          key38 = input.readByte();
          val39 = new ttypes.CumulativeAmount();
          val39.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem48 = null;
          elem48 = new ttypes.SealedTransaction();
          elem48.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem88 = null;
          elem88 = new ttypes.SmartContract();
          elem88.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem106 = null;
          elem106 = new general_ttypes.Variant();
          elem106.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem114 = null;
          elem114 = new general_ttypes.MethodDescription();
          elem114.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem122 = null;
          elem122 = new ttypes.SmartContractMethodArgument();
          elem122.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem130 = null;
          elem130 = new ttypes.SmartContractMethod();
          elem130.read(input);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i136 = 0; _i136 < _size131; ++_i136)
        {
          var key137 = null;
          var val138 = null;
          key137 = input.readString();
          val138 = new general_ttypes.Variant();
          val138.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem148 = null;
          elem148 = new general_ttypes.ByteCodeObject();
          elem148.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem156 = null;
          elem156 = new general_ttypes.Variant();
          elem156.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem172 = null;
          elem172 = new ttypes.TokenTransfer();
          elem172.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem180 = null;
          elem180 = new ttypes.TokenTransaction();
          elem180.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem188 = null;
          elem188 = new ttypes.TokenHolder();
          elem188.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem212 = null;
          elem212 = new ttypes.TrustedInfo();
          elem212.read(input);
