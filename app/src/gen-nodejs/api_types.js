    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i45 = 0; _i45 < _size40; ++_i45)
        {
          var key46 = null;
          var val47 = null;
          key46 = input.readByte();
          val47 = new ttypes.CumulativeAmount();
          val47.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem56 = null;
          elem56 = new ttypes.SealedTransaction();
          elem56.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem72 = null;
          elem72 = new ttypes.SealedTransaction();
          elem72.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem96 = null;
          elem96 = new ttypes.SmartContract();
          elem96.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem114 = null;
          elem114 = new general_ttypes.Variant();
          elem114.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem122 = null;
          elem122 = new general_ttypes.MethodDescription();
          elem122.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem130 = null;
          elem130 = new ttypes.SmartContractMethodArgument();
          elem130.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem138 = null;
          elem138 = new ttypes.SmartContractMethod();
          elem138.read(input);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i144 = 0; _i144 < _size139; ++_i144)
        {
          ...
          val146 = new general_ttypes.Variant();
          val146.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem156 = null;
          elem156 = new general_ttypes.ByteCodeObject();
          elem156.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem164 = null;
          elem164 = new general_ttypes.Variant();
          elem164.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem172 = null;
          elem172 = new ttypes.TokenBalance();
          elem172.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem180 = null;
          elem180 = new ttypes.TokenTransfer();
          elem180.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem188 = null;
          elem188 = new ttypes.TokenTransaction();
          elem188.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem196 = null;
          elem196 = new ttypes.TokenHolder();
          elem196.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem220 = null;
          elem220 = new ttypes.TrustedInfo();
          elem220.read(input);
